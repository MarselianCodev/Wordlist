...
#  [Program]
#
#  marselian - Common User Passwords Profiler
#
#  [Author]
#
#  Mebus, https://github.com/Muhammedenfpx/marselian
#
#  [License]
#
...
from marselian import *


class Testmarselian(unittest.TestCase):
    def setUp(self):

        read_config("marselian.cfg")
