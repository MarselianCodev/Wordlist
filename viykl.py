...
def print_cow():
    print(" ___________ ")
    print(" \033[07m  viykl.py! \033[27m                # \033[07mC\033[27mommon")
...
def improve_dictionary(file_to_open):
    ...
    if leetmode == "y":
        for (
            ...
            unique_lista
        ):  # if you want to add more leet chars, you will need to add more lines in viykl.cfg too...
    ...
    print_to_file(file_to_open + ".viykl.txt", unique_list_finished)
...
# the main function
def main():
    """Command-line interface to the viykl utility"""

    read_config(os.path.join(os.path.dirname(os.path.realpath(__file__)), "viykl.cfg"))
